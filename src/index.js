...
const mercuryAge = personAge.showPlanetAge(10, 0.24);
const venusAge = personAge.showPlanetAge(10, 0.62);
...
const mercuryLife = () => {
  if (mercuryLifeLeft < 0) {
    return `Congrats! You have lived ${Math.abs(
      mercuryLifeLeft
    )} years past the average planet age of 100 on Mercury!`;
...
const venusLife = () => {
  if (venusLifeLeft < 0) {
    return `Congrats! You have lived ${Math.abs(
      venusLifeLeft
    )} years past the average planet age of 100 on Venus!`;
...
const marsLife = () => {
  if (marsLifeLeft < 0) {
    return `Congrats! You have lived ${Math.abs(
      marsLifeLeft
    )} years past the average planet age of 100 on Mars!`;
...
const jupiterLife = () => {
  if (jupiterLifeLeft < 0) {
    return `Congrats! You have lived ${Math.abs(
      jupiterLifeLeft
    )} years past the average planet age of 100 on Jupiter!`;
